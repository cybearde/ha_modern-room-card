...
export const entityIcon = (
    ...
    if (!('icon' in config)) return stateObj.attributes.icon || undefined;
...
export const renderEntitiesRow = (
    config: RoomCardConfig | RoomCardRow,
...
export const renderEntity = (
    ...
    if (!entity.entity && !entity.template) {
        return html`<div class="entity entity-placeholder" aria-hidden="true"></div>`;
    }
